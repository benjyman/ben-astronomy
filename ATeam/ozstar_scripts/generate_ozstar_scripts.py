...
def get_obsid_list(image_number):
   ...
   if image_number==1:
      ...
      #compare to image 4, mostly same data. made little difference
      ...
      lst_list_2015   = ['12.099','14.271','12.1','14.272','12.099','14.271']
      lst_list_2018   = ['13.154','13.234','13.313','13.392','13.471','12.625']
      ...
      lst_list_2015   = ['12.1','14.272','12.099','14.271','12.1','14.272']
      lst_list_2018   = ['13.629','13.787','13.866','13.943','14.022','14.259']
