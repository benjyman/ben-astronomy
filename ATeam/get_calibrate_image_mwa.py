...
#image_10
#maybe leave out 1234301040 - high stddev
...
##probly dont need image 12 - only 2 2018 obs left..
...
def average_images(base_dir,image_list,output_name_base,weighted_average=True):
   ...
   for image_name_index,image_name in enumerate(image_list):
      ...
      region_check_name = 'region_check_%s.fits' % image_name_index 
...
calibrate_obs(obsid_list_2015,model_wsclean_txt='/md0/code/git/ben-astronomy/ATeam/CenA/models/CenA_core_wsclean_model.txt',generate_new_beams=True,ms_dir="/md0/ATeam/CenA/image_11/2015")
calibrate_obs(obsid_list_2018,model_wsclean_txt='/md0/code/git/ben-astronomy/ATeam/CenA/models/CenA_core_wsclean_model.txt',generate_new_beams=True,ms_dir="/md0/ATeam/CenA/image_11/2018")

ms_qa(obsid_list_2015,['/md0/ATeam/CenA/image_11/2015'],data_column="CORRECTED_DATA")
ms_qa(obsid_list_2018,['/md0/ATeam/CenA/image_11/2018'],data_column="CORRECTED_DATA")


#chgcentre for obs pointed off cena (image 7 and 8)
chgcentre_ms(obsid_list_2015,['/md0/ATeam/CenA/image_11/2015'],target='CenA')
chgcentre_ms(obsid_list_2018,['/md0/ATeam/CenA/image_11/2018'],target='CenA')
