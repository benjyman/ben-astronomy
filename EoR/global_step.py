...
mwa_latitude_pyephem_opposite = "26:42.199"
mwa_longitude_pyephem_opposite = "-116:40.2488"
...
#ov.view()
fig_name="sky_from_mwa_at_h_m_s_%02d_%02d_%02d_full_sky_mean_subtr.png" % (hour,minute,second)
figmap = plt.gcf()
figmap.savefig(fig_name,dpi=500)
print "saved %s" % fig_name
plt.close()
...
visibility_amp_array_iso_filename = "visibility_amp_list_iso.npy"
visibility_amp_array_short_para_filename = "visibility_amp_array_short_para.npy"
visibility_real_array_short_para_angular_filename = "visibility_real_array_short_para_angular.npy"
visibility_imag_array_short_para_angular_filename = "visibility_imag_array_short_para_angular.npy"
...
if not plot_only:
   ...
   visibility_amp_array_short_para = np.asarray(visibility_amp_list_short_para)
   ...
   np.save(visibility_amp_array_short_para_filename,visibility_amp_array_short_para)
...
if plot_only:
   ...
   visibility_amp_array_short_para = np.load(visibility_amp_array_short_para_filename)
...
visibility_amp_array_short_para_norm = visibility_amp_array_short_para/visibility_amp_array_short_para[0]
visibility_amp_array_short_para_norm_abs = np.abs(visibility_amp_array_short_para_norm)
...
visibility_real_array_short_para_angular_norm = visibility_real_array_short_para_angular/visibility_amp_array_short_para[0]
...
visibility_imag_array_short_para_angular_norm = visibility_imag_array_short_para_angular/visibility_amp_array_short_para[0]
...
plt.plot(baseline_length_lambda_array,visibility_amp_array_short_para_norm,label="global")
...
#plot_title="Vis ampl vs freq baseline:%0.1fm and sep %0.1fm" % (baseline_length_m,linear_array_ant_separation)
plot_figname="visibility_amp_abs_vs_baseline_length.png"
plt.plot(baseline_length_lambda_array,visibility_amp_array_short_para_norm_abs,label="global")
