   ...
   with open('%s' % sbatch_filename,'w') as outfile:
      ...
      for type in type_list:
         if (type=="gsm" or type=="EDGES_uniform" or type=="unity_uniform"):
            ...
            outfile.write("   --cat_filename=source_lists/%s \\\n" % sourcelist_name)
            ...
            for pol in pol_list:
               if type =="angular":
                  ...
                  output_uvfits_prepend = "/astro/mwaeor/bmckinley/EoR/ASSASSIN/WODEN/data/woden_LST_%0.3f_gsm_start_freq_%0.3f_pol_%s_angular" % (LST_deg,start_freq_MHz,pol)
